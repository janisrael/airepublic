...
def main():
    try:
        job_id = 1
        logger.info("🚀 Starting LoRA training for r22")
        send_output_to_frontend(job_id, "🚀 Starting LoRA training for r22")
        
        # Model and data paths
        base_model = "microsoft/DialoGPT-medium"
        train_data_path = "training_data/job_1/train.jsonl"
        val_data_path = "training_data/job_1/val.jsonl"
        output_dir = f"models/r22_lora"
        ...
        # Save merged model
        merged_output_dir = f"models/r22_lora_merged"
