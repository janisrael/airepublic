#!/usr/bin/env python3
"""
LoRA Training Script for TestEvaluation
...
def main():
    try:
        job_id = 5
        logger.info("🚀 Starting LoRA training for TestEvaluation")
        send_output_to_frontend(job_id, "🚀 Starting LoRA training for TestEvaluation")
        
        # Model and data paths
        base_model = "microsoft/DialoGPT-medium"
        train_data_path = "training_data/job_5/train.jsonl"
        val_data_path = "training_data/job_5/val.jsonl"
        output_dir = f"models/TestEvaluation_lora"
        ...
        # Save merged model
        merged_output_dir = f"models/TestEvaluation_lora_merged"
